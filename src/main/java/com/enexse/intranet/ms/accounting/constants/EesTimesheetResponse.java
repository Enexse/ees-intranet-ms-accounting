...
public class EesTimesheetResponse {

    //User
    public static final String EES_USER_NOT_FOUND = "user not found";

    //user Timesheet
    public static final String EES_USER_TIMESHEET_NOT_FOUND = "user timesheet not found";
    ...
    // TIMESHEET WORKTIME
    public static final String EES_TIMESHEET_WORKTIME_PREFIX = "EES-WORKTIME-";
    public static final String EES_TIMESHEET_WORKTIME_CODE_COULD_NOT_BE_NULL = "TimeSheet worktime hours code could not be null";
    public static final String EES_TIMESHEET_WORKTIME_CODE_INVALID_FORMAT = "TimeSheet worktime must starts with EES-WORKTIME-";
    public static final String EES_TIMESHEET_WORKTIME_ALREADY_EXISTS = "TimeSheet worktime already exists with code %s. Try another one";
    public static final String EES_TIMESHEET_WORKTIME_CREATED = "TimeSheet worktime created Successfully";
    public static final String EES_TIMESHEET_WORKTIME_NOT_FOUND = "Worktime not found";
    public static final String EES_UPDATE_BY_CODE_TIMESHEET_WORKTIME = "TimeSheet worktime updated successfully.";
    public static final String EES_TIMESHEET_WORKTIME_DELETED = "TimeSheet worktime deleted successfully";
